...
int i_init=500,j_init=500;  //initial position of the bot-to account for any protrusions towards the left side.
String state;           

std::vector< std::vector<String> > room(1000,std::vector<String>(1000));	//room is divided into cells(40cm*40cm-about the bot's dimensions-to assign a unique position to the bot)-each cell represented by a coordinate
